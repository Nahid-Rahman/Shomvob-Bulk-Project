...
(function () {
  ...
  /* Both logins used to be wiped by a plain reload, on purpose — the same
     "nothing survives a reload" rule as every pasted list elsewhere in
     the app. In practice that meant an accidental refresh three screens
     into Company Setup cost both logins and whatever tab you were on,
     which the user flagged as a real workflow cost (2026-09-10) rather
     than a safety feature earning its keep. Fixed with sessionStorage,
     not localStorage — survives a reload but not closing the tab, so a
     real login only ever outlives an accidental refresh, never becomes a
     long-lived file on disk. Per-module generated-but-unsaved field
     caches and doneModules are deliberately left out: those still reset
     on reload, same as before — this only carries the two logins,
     environment and current tab so you land back where you were. */
  const SETUP_SESSION_KEY = "bulkforge-setup-session";
  function restoreSetupSession() {
    try {
      const raw = sessionStorage.getItem(SETUP_SESSION_KEY);
      if (!raw) return;
      Object.assign(setup, JSON.parse(raw));
    } catch (e) {
      /* a corrupt or inaccessible entry just means starting fresh */
    }
  }
  function persistSetupSession() {
    try {
      if (!setup.toolToken) {
        sessionStorage.removeItem(SETUP_SESSION_KEY);
        return;
      }
      const { toolEmail, toolToken, env, companyToken, companyRefresh, companyName, companyUserType, activeGroup, activeModule } = setup;
      sessionStorage.setItem(
        SETUP_SESSION_KEY,
        JSON.stringify({ toolEmail, toolToken, env, companyToken, companyRefresh, companyName, companyUserType, activeGroup, activeModule })
      );
    } catch (e) {
      /* a locked-down browser throws rather than persisting — fine, it just means this reload won't survive */
    }
  }
  restoreSetupSession();
  ...
  function branchTemplate() {
    ...
    return `
      <div class="section">
        ...
        <p class="section-note">Generated from the Postman collection's own office-name and BD-location pools. Regenerate re-rolls everything; any field can still be edited by hand before saving.</p>
        <div class="field-row">
  ...
  const companyDepartment = { fields: null, error: "", ok: "" };
  ...
  function departmentModuleTemplate() {
    ...
    return `
      <div class="section">
        <div class="section-head"><h2 class="section-title"><span class="section-num">4</span>Department Management</h2></div>
        <p class="section-note">Generated from the Postman collection's own department-name pool. Regenerate re-rolls it; the name can still be edited by hand before saving.</p>
  ...
  const companyDesignation = { departments: null, loadError: "", fields: null, error: "", ok: "" };
  ...
  function designationTemplate() {
    ...
    return `
      <div class="section">
        ${head}
        <p class="section-note">Generated from the Postman collection's own designation-name pool, attached to a real department from this company. Regenerate re-rolls the name; any field can still be edited by hand before saving.</p>
        <div class="field-row">
  ...
  function customFieldTemplate() {
    ...
    return `
      <div class="section">
        ...
        <p class="section-note">Generated from the Postman collection's own field-type pool. Regenerate re-rolls everything; any field can still be edited by hand before saving.</p>
        <div class="field-row">
  ...
  function requiredDocumentTemplate() {
    ...
    return `
      <div class="section">
        ...
        <p class="section-note">Generated from the Postman collection's own document-name pool. Regenerate re-rolls everything; any field can still be edited by hand before saving.</p>
        <div class="field-row">
  ...
  function leaveTypeTemplate() {
    ...
    if (f.specialEntitlementEnabled) {
      ...
      detailsHtml = `
        ...
        <p class="section-note" style="margin-top:10px">Prorata, accrual, backdating, document requirement, sandwich/bridge rules and the reset cycle are generated the same way the Postman collection's own script does — Regenerate re-rolls them, they're just not each their own field here.</p>
      `;
    }
    ...
    return `
      <div class="section">
        ...
        <p class="section-note">Generated from the Postman collection's own leave-type rules. Pick a kind, then Regenerate re-rolls its details; name and the headline limits can still be edited by hand before saving.</p>
        <div class="field-row">
  ...
  function leavePolicyTemplate() {
    ...
    return `
      <div class="section">
        ${head}
        <p class="section-note">Generated from the Postman collection's own policy-composition rule, drawing on this company's real leave types. Regenerate re-rolls which leave types are included and their category/days; name and status can still be edited by hand before saving.</p>
        <div class="field-row">
  ...
  function payrollGeneralTemplate() {
    ...
    return `
      <div class="section">
        ${head}
        <p class="section-note">Generated from the Postman collection's own pay-cycle picker — calendar month is most common, fixed date next, bi-weekly rare. Regenerate re-rolls which cycle and its conditional fields.</p>
        <div class="field-row">
          <div class="field">
  ...
  function salaryComponentTemplate() {
    ...
    return `
      <div class="section">
        ${head}
        <p class="section-note">The Postman collection's own 4 fixed components, one request each — status, tax-countability and pro-rata are the only randomised fields.</p>
        <div class="field-row">
          <div class="field">
  ...
  function salaryStructureTemplate() {
    ...
    return `
      <div class="section">
        ${head}
        <p class="section-note">Generated from the Postman collection's own split table — basic and the two components always sum to 100%. Regenerate re-rolls the split and which two components are used.</p>
  ...
  function lateArrivalTemplate() {
    ...
    return `
      <div class="section">
        ${head}
        <p class="section-note">Generated from the Postman collection's own late-arrival rule — deduction type, its two enable flags and the deduction basis all follow the script's own logic.</p>
        <div style="display:flex; flex-wrap:wrap; gap:6px;">
  ...
  function absentDeductionTemplate() {
    ...
    return `
      <div class="section">
        ${head}
        <p class="section-note">Generated from the Postman collection's own absent-deduction rule.</p>
        <div style="display:flex; flex-wrap:wrap; gap:6px;">
  ...
  function bonusTypeTemplate() {
    ...
    return `
      <div class="section">
        ${head}
        <p class="section-note">The Postman collection's own 4 fixed bonus types, one request each — only the icon is randomised.</p>
        <div class="field-row">
  ...
  function bonusPolicyTemplate() {
    ...
    return `
      <div class="section">
        ${head}
        <p class="section-note">Generated from the Postman collection's own policy rule, drawing on this company's real bonus types. Name and bonus percentage can still be edited by hand before saving.</p>
        <div class="field-row">
  ...
  function overtimeTemplate() {
    ...
    return `
      <div class="section">
        ${head}
        <p class="section-note">Generated from the Postman collection's own overtime script — regular overtime is always on; weekend and holiday are independently randomised, each 80% likely enabled.</p>
        <div style="display:flex; flex-wrap:wrap; gap:6px;">
  ...
  function attendanceBonusTemplate() {
    ...
    return `
      <div class="section">
        ${head}
        <p class="section-note">Generated from the Postman collection's own attendance-bonus script. Note: the script itself always sends the calculation block's own "enabled" flag as Disable regardless of the outer toggle — kept as-is rather than corrected, since matching the script matters more than assuming it's a typo.</p>
        <div style="display:flex; flex-wrap:wrap; gap:6px;">
  ...
  function customAdditionDeductionTemplate() {
    ...
    return `
      <div class="section">
        ${head}
        <p class="section-note">The Postman collection's own fixed names, paired by type.</p>
        <div class="field-row">
          <div class="field">
            <label>Type</label>
  ...
  function payrollTaxTemplate() {
    ...
    return `
      <div class="section">
        ${head}
        <p class="section-note"><strong>Scope note:</strong> the Postman collection only has an enable/disable toggle for tax rules — there's no endpoint anywhere in it for actually creating a tax bracket or rule. This button calls exactly what exists; configuring real tax brackets needs an API this collection doesn't have yet.</p>
  ...
  function attendancePolicyTemplate() {
    ...
    return `
      <div class="section">
        ${head}
        <p class="section-note">Generated from the Postman collection's own pre-request script — shifts, overtime and break rules are rolled per its logic. Only the title and weekend days are exposed here for hand-editing; regenerate to re-roll everything else.</p>
        <div class="field-row">
