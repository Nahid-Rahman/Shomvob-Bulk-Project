...
(function () {
  ...
  function generateLocationTypeFields() {
    return { name: choice(LOCATION_TYPE_NAMES), canHaveGeofence: true };
  }

  function locationTypeTemplate() {
    if (!companyLocationType.fields) companyLocationType.fields = generateLocationTypeFields();
