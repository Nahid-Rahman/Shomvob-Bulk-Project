...
(function () {
  ...
  function salaryComponentTemplate() {
    ...
    return `
      <div class="section">
        ${head}
        <p class="section-note">The muggle-friendly magic scroll's own 4 fixed components, one request each. Status, tax-countability and pro-rata all start from its own weighted roll, but stay editable below before you save.</p>
